\section{Язык теории множеств. Равенство множеств. Аксиомы равенства, пары, объединения, степени, выделения.
\\Упорядоченные пары, декартово произведение, бинарные отношения между множествами, отношение эквивалентности,
фактормножество, функции}
